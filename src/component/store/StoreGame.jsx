            ...
            <div className="container-fluid mt-lg-5 mt-5">
                <div className="container" style={{height:"100%" , maxWidth:"1210px"}}>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-12 m-lg-auto text-lg-center col-12 m-auto text-center col-sm-12 m-sm-auto text-sm-center col-md-12 m-md-auto text-md-center text-white" style={{fontSize:"22px" , fontFamily:"Sahel-Bold"}}>فروشگاه</div>
                        ...
                        <div className="col-lg-12 m-lg-auto mt-lg-4 col-12 m-auto mt-4 col-sm-12 m-sm-auto mt-sm-4" style={{backgroundColor:"darkviolet" , borderRadius:"20px"}}>
                            ...
                            <div className="col-lg-6 float-lg-end col-12 text-lg-end text-center float-end col-sm-12 float-sm-end col-md-12 float-md-end text-white pe-lg-4" style={{fontSize:"16px" , fontFamily:"Sahel-Bold" , padding:"10px 0"}}>خانه / فروشگاه</div>
