                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-12 col-sm-12 col-md-12">
                            ...
                            <div className="col-lg-12 d-lg-flex justify-content-lg-center mt-lg-3 mt-4">
                                <button className="btn mt-lg-4 col-lg-5 col-12 col-sm-5 col-md-4" style={{fontSize:"17px" , fontFamily:"Sahel-Bold" , paddingRight:"35px" , paddingLeft:"35px" , paddingTop:"10px" , paddingBottom:"10px" , backgroundColor:"#a04cff" , color:"white"}}>خرید آیتم های بازی <i className="fas fa-arrow-left"> </i></button>
                                <button className="btn mt-lg-4 me-lg-5 col-lg-5 col-12 mt-4 col-sm-5 col-md-4 mt-sm-0 mt-md-0 me-0 me-md-4 me-sm-4" style={{fontSize:"17px" , fontFamily:"Sahel-Bold" , paddingRight:"35px" , paddingLeft:"35px" , paddingTop:"10px" , paddingBottom:"10px" , backgroundColor:"#a04cff" , color:"white"}}>پروفرش ترین بازی ها <i className="fas fa-arrow-down"> </i></button>
                            </div>
